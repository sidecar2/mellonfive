...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        opening: function() {
            ...
            $('p.post').addClass("select_on");
             $('.select2-container .select2-choice span').addClass("dim");

            $('p.add_post').removeClass("selected_on");
             if ( $("#new_form").hasClass("getup") ) {
            $("#new_form").removeClass("getup")};
            if ( $("#add_new").hasClass("open") ) {
            $("#add_new").removeClass("open")};
        ...
        close: function () {
            ...
            $('#add_new').addClass("slim");
             $('.select2-container .select2-choice span').removeClass("dim");
